...
gasoline_factor <- readxl::read_xlsx("_meta/data-raw/ghg-emission-factors-hub-2021.xlsx",
  range = "C115:F217"
) %>%
...
alt_fuel_factor <- readxl::read_xlsx("_meta/data-raw/ghg-emission-factors-hub-2021.xlsx",
  range = "C222:G258"
) %>%
