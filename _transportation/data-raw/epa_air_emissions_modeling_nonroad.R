...
if (any(purrr::map(
  c(
    ...
    "_transportation/data-raw/epa/air_emissions_modeling/2022v2/2022he_cb6_22m/inputs/nonroad/nonroad_ff10_2022v2_by2022_MOVES_ROC_AE6_07may2025_nf_v3.csv"
...
nonroad_mn_wi <- purrr::map(
  list.files("_transportation/data-raw/epa/air_emissions_modeling/air_emissions_modeling_mn_wi/nonroad/", full.names = TRUE),
  readRDS
) %>%
  bind_rows()
