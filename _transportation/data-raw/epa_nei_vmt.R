...
if (!file.exists("_transportation/data-raw/epa/nei/2020NEI/2020NEI_onroad/inputs/onroad/VMT_2020NEI_full_monthly_run3_09jan2023_v0.csv")) {
  ...
  download.file(
    "https://gaftp.epa.gov/Air/nei/2020/doc/supporting_data/onroad/EIC_SCC_XWALK_042721.xlsx",
  ...
  unzip(
    zipfile = "_transportation/data-raw/epa/nei/2017NEI/2017NEI_onroad_activity_final.zip",
  ...
  unzip(
    zipfile = "_transportation/data-raw/epa/nei/2014NEI/2014v2_onroad_activity_final.zip",
  ...
  unzip(
    zipfile = "_transportation/data-raw/epa/nei/2011NEI/2011neiv2_supdata_or_VMT.zip",
    exdir = "_transportation/data-raw/epa/nei/2011NEI/",
    overwrite = TRUE
  )

  download.file(
    "https://gaftp.epa.gov/air/nei/2011/doc/2011v2_supportingdata/onroad/2011neiv2_supdata_or_SCC.zip",
  ...
  download.file(
    "https://gaftp.epa.gov/air/nei/2008/doc/2008v3_supportingdata/scc_eissector_xwalk_2008neiv3.xlsx",
...
nei_vmt <- purrr::map_dfr(
  c(
    "_transportation/data-raw/epa/nei/2008NEI/section4-mobile/onroad/activity_data_2008/VMT_NEI_2008_updated2_18jan2012_v3",
...
nei_vmt %>%
  ...
  summarize(total_vmt = sum(ann_parm_value)) %>%
  View()
