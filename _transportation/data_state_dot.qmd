...
As required by federal law, Minnesota and Wisconsin state departments of transportation (MnDOT and WisDOT) report various traffic measures for planning, forecasting, and various analysis endeavors. AADT and VMT are high quality government datasets with strong validation practices. 
...
Only `r nrow(commercial_calibration_points)` calibration roads were used for this inventory due to data availability constraints. 
...
- AADT/VMT are generally estimated for high-use arterials and highways, leaving local roads out.
