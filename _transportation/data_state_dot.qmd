...
- CTU has sampled data on local route systems (including Municipal State Aid Streets) during any year from 2017-2023. Read more about route system designations in [mndot_route_system.R](data-raw/mndot_route_system.R).
