...
CO~2~ equivalence (CO~2~e) values are derived from global warming potential (GWP) values [@ipccClimateChange20142014].
...
epa_moves %>%
  rowwise() %>% 
  mutate(`Kilograms CH4 per mile` = ch4/1000,
...
lggit_kg_emissions_per_mile %>% 
  select(`Vehicle Type`, `Vehicle Year`,
         `Fuel Type`,
