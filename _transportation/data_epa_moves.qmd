...
lggit_pass <- lggit_clean %>% 
  ...
  summarize(value = weighted.mean(value, weight_value))
...
#| fig-cap: "EPA MOVES4 and GHG Emissions Hub per mile emission rates by vehicle weight"
#| out-width: "95%"
#| out-height: "250px"
plot_ly(
  data = epa_plus_moves %>% 
  ...
  plotly_layout(
    main_title = "EPA MOVES4 and GHG Emissions Hub per mile emission rates",
