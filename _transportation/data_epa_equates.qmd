...
EQUATES (EPA’s Air QUAlity TimE Series) is a set of modeled emissions and supporting data developed by EPA scientists spanning years 2002 to 2019. EQUATES is particularly useful in that it uses modern source classification codes (SCCs) to provide a continuous time series [@usepaEQUATESEPAsAir2024].
...
EQUATES data are only available from a single consistent website, and so verification across locations was not neccessary. 
