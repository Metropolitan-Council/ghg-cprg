...
fig_modeled_marginal_vmt <-
  ...
  plotly_layout(
    ...
    # y_title = "% of county VMT accounted for",
    main_title = "Modeled COCTU VMT as proportion of county marginal VMT "
  ) %>%
  layout(
    barmode = "stack",
    yaxis = list(tickformat = "1%"),
