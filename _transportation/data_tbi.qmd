...
Data were imported directly from a Council-maintained [public GitHub repository](https://github.com/Metropolitan-Council/metc.tbi.helper). The calculations below were verified from other Council analysis projects using the same dataset. 

```{r tbl-tbi-hh-county-dist}
#| tbl-cap: "TBI household survey geographic distribution"
#| out-width: "95%"
