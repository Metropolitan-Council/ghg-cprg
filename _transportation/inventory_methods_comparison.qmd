# Transportation emissions inventory method comparison
```{r  include=FALSE}
...
Ultimately, our data relies on EPA datasets. Full documentation can be found in @sec-epa-emissions-data-transportation. 
...
At the time, Met Council researchers chose to use an activity-induced method to provide the most actionable information for jurisdictions within our region in both the recent PCAP and the 2018 Metro Climate Stats inventory.
