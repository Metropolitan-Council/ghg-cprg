...
The EPA and various partner agencies continually work on emissions inventories for various projects. [Air Emissions Modeling Platform](https://www.epa.gov/air-emissions-modeling/emissions-modeling-platforms) data are available for several years, but only years `r aem_years$emissions_year %>% listify()` are used in the final inventory.

Both the 2021 and 2022 estimates are based on the 2020 NEI [@usepa2022v2EmissionsModeling2025, @usepa2021EmissionsModeling2024]. Platform 2022v2, released in September 2025, is the most recent and up to date on-road emissions inventory for our region. 
