...
Aviation emissions are derived from four data sources: Metropolitan Airport Commission (MAC) fuel distribution (2005, 2021), MAC Aircraft emission estimates (2016-2020) [@macTotalEmissions2025], MPCA state GHG inventories, and EPA Air Emissions Modeling Platform point sources [@usepa2022v2EmissionsModeling2025]. 
