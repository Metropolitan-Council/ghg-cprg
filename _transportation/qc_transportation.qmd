...
1. Ensure the GWPs used for the local estimate and the LGGIT [@epaLocalGreenhouseGas2017] estimate are on the same basis. The LGGIT tool uses AR5 GWP (e.g., methane GWP = 28).
