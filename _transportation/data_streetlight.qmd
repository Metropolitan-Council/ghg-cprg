...
fig_stl_trip_dist_matrix_pass <- plot_ly(
...
StreetLight also provides a rough estimation of the overall trip distance distribution. Use the widget below to find the distributions of various origin-destination pairs. 
...
fig_stl_trip_dist_matrix_med <- plot_ly(
...
fig_stl_trip_dist_matrix_heavy <- plot_ly(
  data = comm_trip_length_bin %>%
...
fig_stl_trip_dist_matrix_heavy
```
