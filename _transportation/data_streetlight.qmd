...
For ease of access, we used [`{streetlightR}`](https://github.com/Metropolitan-Council/streetlightR), an R package, to interact directly with the StreetLight API. `{streetlightR}` is open-source and maintained by Council staff. 
