...
vmt_emissions_all <- vmt_emissions %>%
  ...
  summarise(
    ...
    emissions_tonnes_co2e = sum(emissions_tonnes_co2e)
  )
...
plot_ly(
  ...
  data = vmt_emissions,
  y = ~reorder(zone, emissions_tonnes_co2e),
  x = ~emissions_tonnes_co2e,
  color = ~vehicle_weight_label,
  hovertemplate = ~ paste0(
    zone, " County", "<br>",
    vehicle_weight_label, "<br>",
    round(emissions_tonnes_co2e * 1e-6, digits = 2), " million tonnes", "<br>",
    "<extra></extra>"
  )
) %>%
  plotly_layout(
    ...
    subtitle = "",
    y_title = "County",
    x_title = "Greenhouse gases emitted (tonnes)",
...
plot_ly(
  ...
  hovertemplate = ~ paste0(
    ...
    "Emissions: ", round(emissions_tonnes_co2e * 1e-6, digits = 2), " million tonnes", "<br>",
    "<extra></extra>"
  ),
  opacity = 0.7,
  marker = list(
...
plot_ly(
  ...
  hovertemplate = ~paste0(
    "County: ", zone, "<br>",
    "Annual VMT: ", round(annual_vmt * 1e-9), " billion<br>",
    "StreetLight VMT: ", round(vmt_total * 1e-9), " billion<br>",
    "<extra></extra>"
  ),
  opacity = 0.7,
  marker = list(
