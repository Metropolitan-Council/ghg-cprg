...
emissions_current_year <- county_emissions %>%
...
This is the transportation section for estimating on-road emissions. Modes included are `r listify(modes_available)`. 
...
fig_transportation_county_emissions <- plot_county_sector_emissions(
  county_emissions %>%
    filter(year == emissions_current_year),
...
fig_transportation_county_emissions_by_weight <- plot_ly(
  ...
  y = ~reorder(county_, emissions_metric_tons_co2e),
