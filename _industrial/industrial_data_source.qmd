...
nei_no_doublecount <- left_join(nei_emissions %>% 
...
When expanding to industrial point sources that combust fuel but have additional subparts, we see that they lie on or above the 1:1 line (excepting the previously discussed HERC), which is what we would expect. There are process emissions in addition to fuel combustion.
