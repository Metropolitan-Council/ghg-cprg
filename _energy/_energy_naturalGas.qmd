...
natGasEmissions_all <- rbind(mn_emissions, wi_emissions) %>%
  ...
  summarise(
    emissions_metric_tons_co2e = sum(total_CO2e_emissions_tons),
    .groups = "rowwise"
  )
