...
#### Comparison with federal inventory

To instill additional confidence in our numbers, we compared our county-level emissions figures to estimates derived from the EIA's State Electricity Profiles, which were generated by down-scaling the Minnesota and Wisconsin state-level numbers using the proportions of each state's population residing in our study area counties (thereby generating county-level estimates).
...
plot <- plot_ly(
  ...
  layout(
    title = "Emissions Inventory QA - Comparison between EIA and MetC inventories",
    ...
    legend = list(
      ...
      font = list(size = 10), # Adjust the size of the legend text
      # If you want to adjust the legend text further, use the 'name' attribute in plot_ly
      traceorder = 'normal' # This sets the order in which the legend items appear
    )
  )
