...
fig_electricity_county_emissions <- plot_ly(
  ...
  hovertemplate = ~ paste0(
    geog_name, "<br>",
    "Electricity", "<br>",
    "Emissions: %{x:,.0f} metric tons CO<sub>2</sub>e", "<br>",
    "<extra></extra>"
  )
) %>%
  plotly_layout(
...
fig_emissions_population <- plot_ly(
  data = emissions_population,
  source = "fig-emissions-population",
  x = ~population,
...
eiaQA_plot <- plot_ly(
  ...
  plotly_layout(
    ...
    x_title = "Total population",
    y_title = "Metric tons CO<sub>2</sub>e"
    main_title = "Electricity Emissions Inventory QA<br><sub>Comparison between MetC and EIA State Electricity Profiles</sub>",
    y_title = "Metric tons CO<sub>2</sub>e",
    x_title = "County",
...
nrelQA_plot <- plot_ly(
  ...
  plotly_layout(
    main_title = "Electricity Emissions Inventory QA<br><sub>Comparison between MetC and NREL SLOPE</sub>",
    y_title = "Metric tons CO<sub>2</sub>e",
    x_title = "County",
    legend_title = "Inventory source",
  ) %>%
