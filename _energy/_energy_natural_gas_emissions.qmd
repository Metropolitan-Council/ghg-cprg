...
Because of the small amount of data, we hard-coded observed information into data frames rather than extracting data through a web scraper or document analyzer (see *processed_wi_electricUtil_activityData.R* on the GitHub repository). All four
