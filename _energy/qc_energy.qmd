...
2. SLOPE [@nrelSLOPEStateLocal2017] data are provided in million British thermal units (MMBtu’s) of electricity usage, EIA 861 usage data are provided in megawatt-hours (MWh), but the LGGIT [@epaLocalGreenhouseGas2017] inputs for electricity usage must be in kilowatt-hours (kWh). When comparing any two datasets, ensure that the units of measure are converted to a consistent basis prior to making the comparison. 
...
tibble::tribble(
  ~"Power Consuming Sector", ~"Initial Local Estimate (Metric Tons CO~2~e)", ~"QC Estimate based on SLOPE (Metric Tons CO~2~e)",
  "Residential", "", "",
  "Commercial", "", "",
  "Industrial", "", "",
  "Transportation", "", "",
