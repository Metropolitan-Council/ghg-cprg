...
county_emissions_summary <- county_emissions %>%
  filter(!category == 'Stock') %>%  #omit carbon stock potential - not a rate so not directly comparable
...
Potential sequestration from natural systems totaled `r round(seq_total, digits = 2)` MMtCO~2~e in the Twin Cities MSA in 2021. Urban forests and grasslands have high sequestration potential, though are expected to have lower stock potential, capping their potential carbon storage in the future.
