...
general_constants <- data.frame(value = ag_constants[2:16,1], description = ag_constants[2:16,2],
                                short_text = c(
                                  "MT_ton",
                                  "lbs_ton",
                                  "kg_lb",
...
soil_plant_constants <- data.frame(value = ag_constants[18:27,1], description = ag_constants[18:27,2],
                                short_text = c(
                                  "NMan",
                                  "NOrg",
                                  "VolOrg",
...
soil_animal_constants <- data.frame(value = ag_constants[18:27,6], description = ag_constants[18:27,7],
                                   short_text = c(
                                     "NonVolEF",
                                     "prpEF",
                                     "LeachEF",
...
crop_residue_mass_ratio <- data.frame(value = ag_constants[29:44,c(3)],
  ...
  mutate(description = paste(description, "residue to crop mass ratio"),
