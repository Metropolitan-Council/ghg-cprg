...
You can access the EPA tool on the [EPA website](https://www.epa.gov/statelocalenergy/download-state-inventory-and-projection-tool) and the MPCA tool through their [Tableau Dashboard](https://public.tableau.com/app/profile/mpca.data.services/viz/GHGemissioninventory/GHGsummarystory).
