...
emissions_2022 <- county_emissions %>%
  ...
  sum()
waste_emissions_2022 <- county_emissions %>%
  filter(emissions_year == 2022, sector == "Waste") %>%
  pull(value_emissions) %>%
  sum()
...
In 2022, waste activities over the entire United States generated emissions of 169.2 MMTCO~2~e, or 2.7 percent of total U.S. greenhouse gas emissions [@usepaInventoryGreenhouseGas2023]. In the 11-county Twin Cities MSA region, municipal waste produced `r round(waste_emissions_2022)/1000000` MMTCO~2~e, or `r 100*round(waste_emissions_2022/emissions_2022, digits = 3)`% of the regional total. 
...
Regional waste emissions have increased by `r round(100 * ((waste_emissions_2022/waste_emissions_2005) - 1), digits = 2)`% since 2005, likely tied to population growth despite successful measures to reduce emissions per capita.
...
CO<sub>2</sub>: `r 100 * round(co2_2022/waste_emissions_2022, digits = 3)`% 
CH<sub>4</sub>: `r 100 * round(methane_2022/waste_emissions_2022, digits = 3)`% 
N<sub>2</sub>O: `r 100 * round(n2o_2022/waste_emissions_2022, digits = 3)`%



```{r fig-waste-county-emissions-by-gas-type}
#| fig-cap: "2022 county waste emissions by gas type"
#| out-width: "95%"
...
fig_waste_gas_type <- plot_ly(
  ...
  plotly_layout(
    main_title = "2022 county waste emissions by gas type",
...
#| fig-cap: "2022 county waste emissions by gas type - CO2e"
#| out-width: "95%"
...
fig_waste_gas_type_co2e <- plot_ly(
  ...
  plotly_layout(
    main_title = "2022 county waste emissions by gas type in CO2e",
...
fig_solid_waste_emissions <-
  ...
  plotly_layout(
    main_title = "2022 solid waste emissions",
    subtitle = "",
    y_title = "County",
...
#| fig-cap: "2022 solid waste emissions by category"
#| out-width: "95%"
...
fig_solid_waste_sector_emissions_by_category <-
  ...
  plotly_layout(
    main_title = "2022 solid waste emissions by category",
    subtitle = "",
    y_title = "County",
    x_title = "Metric tons CO<sub>2</sub>e",
    legend_title = "Category"
...
#| fig-cap: "Solid waste emissions by county, 2005-2022"
#| out-width: "95%"
...
#| fig-cap: "Solid waste emissions by source, 2005-2022"
#| out-width: "95%"
#|
