...
The process for calculating solid waste emissions slightly differs between Minnesota and Wisconsin counties, due to a difference in data availability. Both states use state or federal data sources, the highest quality data rank (@tbl-quality-rank).
