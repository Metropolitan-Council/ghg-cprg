...
if (!file.exists("_waste/data-raw/wastewater_v2/data-raw/wastewater-module.xlsx")) {
...
ww_control <- suppressMessages(
  readxl::read_xlsx("_waste/data-raw/wastewater_v2/data-raw/wastewater-module.xlsx",
                    sheet = "Control"
  ))
...
saveRDS(ww_constants_formatted, "./_waste/data-raw/wastewater_v2/data/epa_wastewater_constants.rds")
saveRDS(ww_constants_meta, "./_waste/data-raw/wastewater_v2/data/epa_wastewater_constants_meta.rds")
