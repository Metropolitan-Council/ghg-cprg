...
# 01 ----------------------------------------------------------------------
source("_waste/data-raw/wastewater_v2/01_compile_ww_constants.R")                          
source("_waste/data-raw/wastewater_v2/01_compile_ww_protein_consumption.R")                

# 02 ----------------------------------------------------------------------
source("_waste/data-raw/wastewater_v2/02_compile_ww_municipal_ch4.R")                      
source("_waste/data-raw/wastewater_v2/02_compile_ww_municipal_n2o_direct.R")               

# 03 ----------------------------------------------------------------------
source("_waste/data-raw/wastewater_v2/03_compile_ww_municipal_n2o_effluent.R")             


# Load constants ----------------------------------------------------------
epa_wastewater_constants <- readRDS("_waste/data-raw/wastewater_v2/data/epa_wastewater_constants.RDS")
epa_protein_consumption <- readRDS("_waste/data-raw/wastewater_v2/data/epa_protein_consumption.RDS")
