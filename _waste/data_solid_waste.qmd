...
In 2013, the MPCA contracted with Burns & McDonnell Engineering Company, Inc. to conduct a waste characterization study of landfill waste, an update to an earlier study in the year 2000 [@mpcaMinnesotaStatewideWaste2013]. For simplicity, we have chosen to set waste proportions equal to those 2013 values for all years in this inventory.
