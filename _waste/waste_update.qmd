...
The methane commitment model calculates methane emissions from landfills for a given year by multiplying municipal solid waste totals by a methane generation potential and adjusting for oxidation,

$$Emissions_{CH_4} = (MSW \times L_0 ) \times (1 – ox) $$

[basically, here is also where you would incorporate methane recovered, BUT I DON'T TRUST THOSE NUMBERS]
...
no recycling emissions calculated because they are accounted for in energy
