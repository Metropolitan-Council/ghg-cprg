...
Given that the most granular solid waste data available is at the county level, waste emissions estimates are allocated to cities by population. County emissions are multiplied by the city or municipality's share of county population. This means that city-level estimates do not account for differences in waste collection programs between cities.
