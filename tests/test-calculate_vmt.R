testthat::test_that("Correct number of calibration zone sets", {
  ...
  testthat::expect_equal(
    unique(names(c(passenger, commercial))),
    c(
      "analysis_name", "mode_of_travel", "zone", "vehicle_weight",
  ...
  testthat::expect_equal(
    unique(c(commercial$zone, passenger$zone)),
    c(
  ...
  testthat::expect_equal(
    unique(c(passenger$vehicle_weight, commercial$vehicle_weight)),
