...
waste_scenarios <- gcam %>% 
  filter(subsector_mc %in% c("Solid waste", "Wastewater"),
...
bau2030 <- waste_2030 %>% filter(scenario == "bau") %>% pull(value_emissions)

ppp2030 <- waste_2030 %>% filter(scenario == "ppp") %>% pull(value_emissions) -
  bau2030
...
bau2050 <- waste_2050 %>% filter(scenario == "bau") %>% pull(value_emissions)

ppp2050 <- waste_2050 %>% filter(scenario == "ppp") %>% pull(value_emissions) -
  bau2050
