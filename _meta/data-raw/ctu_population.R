...
ctu_pop_meta <- tribble(
  ...
  "ctuid", class(ctu_pop_estimates$ctuid), "CTU FIPS tag",
  "gnis", class(ctu_pop_estimates$gnis), "Geographic names information system (GNIS) identifier",
  "coctu_id_fips", class(ctu_pop_estimates$coctu_id_fips), "County-CTU FIPS identifier",
  "coctu_id_gnis", class(ctu_pop_estimates$coctu_id_gnis), "County-CTU GNIS identifier",
