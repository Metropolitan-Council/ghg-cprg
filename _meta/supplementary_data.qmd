...
We can calculate gross emissions rates in grams emitted per vehicle mile traveled for each county by combining the historical VMT (@sec-state-dot-data), VMT forecasts, (@sec-regional-travel-demand-model), compiled historical annual emissions (@sec-epa-emissions-data-transportation), and emissions forecasts (). 
