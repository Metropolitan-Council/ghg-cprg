...
Across all sectors, we used the GWP values established in the Intergovernmental Panel on Climate Change (IPCC) 6th Assessment Report (AR6), Table 7.SM.7 [@intergovernmentalpanelonclimatechangeipccClimateChange20212023]. We processed these values in [global_warming_potential.R](../R/global_warming_potential.R).
