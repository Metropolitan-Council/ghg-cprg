...
This release incorporates major changes to all sectors, including temporal data back to 2005 and fundemental changes in inventory methodology. We also account for industrial and agricultural 
...
- Emissions from previous releases (1.0.0, 1.1.1, etc.) should *not* be directly compared with this and all future releases.
