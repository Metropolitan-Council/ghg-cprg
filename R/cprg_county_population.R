...
cprg_county_meta <- readRDS("R/data/cprg_county_meta.RDS")
library(tidycensus)
...
saveRDS(cprg_population, "R/data/cprg_population.RDS")
saveRDS(cprg_population_meta, "R/data/cprg_population_meta.RDS")
