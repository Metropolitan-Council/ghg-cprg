...
To add a citation to the document you are writing, go to "Addins" and select "Insert a citation". Enable the Zotero connection. Ensure the citation will be written to /references.bib and that the item is added to our Zotero group library. 
